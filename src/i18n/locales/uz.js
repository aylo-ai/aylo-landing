...
export default {
  ...
  /*
    Plan names, descriptions, feature bullets, prices and allowances are NOT
    here — they come from the backend (`src/lib/pricingApi.js`). What lives in
    the locales is the copy wrapped around those numbers.
  */
  pricing: {
    ...
    perMonth: '/oy',
    perDays: '/{count} kun',
    customPrice: 'Kelishiladi',
    customFootnote: 'Narx va shartlar biznesingizga moslab kelishiladi',
    ctaContact: 'Sotuv bo\'limi bilan bog\'lanish',
    freePrice: 'Bepul',
    allowance: 'Oyiga {count} ta suhbat',
    wasPrice: 'Avvalgi narx',
    noCard: 'Karta talab qilinmaydi',
    cancelAnytime: 'Istalgan vaqtda bekor qilinadi',
    ctaFree: 'Bepul boshlash',
    ctaSelect: 'Tarifni tanlash',
    loading: 'Tariflar yuklanmoqda',
    errorTitle: 'Tariflarni yuklab bo\'lmadi',
    errorBody: 'Aloqada muammo bo\'ldi. Qayta urinib ko\'ring yoki biz bilan bog\'laning — narxlarni aytib beramiz.',
    retry: 'Qayta urinish',
    errorContact: 'Bog\'lanish',
