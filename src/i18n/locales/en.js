...
export default {
  ...
  */
  pricing: {
    ...
    customFootnote: 'Price and terms agreed around your business',
    ctaContact: 'Contact sales',
    freePrice: 'Free',
    allowance: '{count} conversations / month',
    wasPrice: 'Regular price',
    ...
    errorBody: 'Something went wrong reaching our servers. Try again, or get in touch and we will send you the prices.',
    retry: 'Try again',
    errorContact: 'Contact us',
